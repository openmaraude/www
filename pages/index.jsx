...
function ChampagneSection() {
  return (
    <>
      <Modal title="C'est en vigueur ⚖️" autoOpen={true}>
        ...
        <p><span class="fr-fi-arrow-right-line fr-fi--md"></span> L’ensemble des conducteurs de taxis de France ont désormais l’obligation de se connecter au registre de disponibilité des taxis le.taxi.</p>
      </Modal>
    </>
  );
}
